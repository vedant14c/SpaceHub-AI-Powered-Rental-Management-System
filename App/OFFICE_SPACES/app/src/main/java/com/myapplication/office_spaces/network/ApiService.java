...
public interface ApiService {
    ...
    Call<List<PropertyImage>> getImagesByPropertyId(@Path("id") int propertyId);
    ...
    Call<Notification> markNotificationRead(@Path("id") int id);
    ...
    @PUT("properties/{id}")
    Call<Property> updateProperty(@Path("id") int id, @Body Property property);
    ...
    Call<AdminUserView> activateUser(@Path("id") int id);

    @PUT("users/deactivate/{id}")
    Call<AdminUserView> deactivateUser(@Path("id") int id);

    @POST("payments/create-order/{requestId}")
    Call<CreateOrderResponse> createOrder(@Path("requestId") int requestId, @Body CreateOrderRequest request);

    @POST("payments/verify")
    Call<Payment> verifyPayment(@Body VerifyPaymentRequest request);

    @DELETE("properties/images/{imageId}")
    Call<ResponseBody> deletePropertyImage(@Path("imageId") int imageId);
}
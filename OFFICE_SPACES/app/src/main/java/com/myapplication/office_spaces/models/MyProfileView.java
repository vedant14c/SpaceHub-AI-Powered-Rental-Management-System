...
public class MyProfileView {
    ...
    public String getPreferredListingType() { return preferredListingType; }
    public void setPreferredListingType(String preferredListingType) { this.preferredListingType = preferredListingType; }
